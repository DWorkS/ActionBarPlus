...
public class PinnedSectionGridView extends AutoScrollGridView {
	...
	private final OnScrollListener mOnScrollListener = new OnScrollListener() {
		...
		public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
			...
			PinnedSectionGridAdapter adapter = (PinnedSectionGridAdapter) getPinnedAdapter();
	...
	void createPinnedShadow(int position) {
		...
		View pinnedView = getAdapter().getView(position, pinnedShadow.view, PinnedSectionGridView.this);
	...
	public static boolean isItemViewTypePinned(ListAdapter adapter, int position) {
		...
		return ((PinnedSectionGridAdapter) adapter).isItemViewTypePinned(position);
	}
