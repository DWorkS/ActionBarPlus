...
public class SimpleDialogFragment extends BaseDialogFragment {
		...
		if (!TextUtils.isEmpty(positiveButtonText)) {
			builder.setPositiveButton(positiveButtonText, new View.OnClickListener() {
				...
				public void onClick(View view) {
					SimpleDialogListener listener = getDialogListener();
					if (listener != null) {
	...
	protected SimpleDialogListener getDialogListener() {
		final Fragment targetFragment = getTargetFragment();
		if (targetFragment != null) {
	...
	public static class SimpleDialogBuilder extends BaseDialogBuilder {
		...
		private SimpleDialogBuilder(Context context, FragmentManager fragmentManager, Class<? extends SimpleDialogFragment> clazz) {
